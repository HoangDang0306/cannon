...
public class PlayerServices {
	public static Player getPlayerByID(int id) {
		TblPlayerInfo tblPlayerInfo = new TblPlayerInfo();
		tblPlayerInfo.setId(id);
		List<DaoValue> list = CommonDaoFactory.Select(tblPlayerInfo);
		...
		tblPlayerInfo = (TblPlayerInfo) list.get(0);
		
		return new Player(tblPlayerInfo);
	}
	
	public static Player getPlayerByName(String name) {
		TblPlayerInfo tblPlayerInfo = new TblPlayerInfo();
		tblPlayerInfo.Set("name", name);
		List<DaoValue> list = CommonDaoFactory.Select(tblPlayerInfo);
